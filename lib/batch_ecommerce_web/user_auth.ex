defmodule BatchEcommerceWeb.UserAuth do
  use BatchEcommerceWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_batch_ecommerce_web_user_remember_me"
  ...
  the current_user:
      ...
      defmodule BatchEcommerceWeb.PageLive do
        use BatchEcommerceWeb, :live_view

        on_mount {BatchEcommerceWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{BatchEcommerceWeb.UserAuth, :ensure_authenticated}] do
